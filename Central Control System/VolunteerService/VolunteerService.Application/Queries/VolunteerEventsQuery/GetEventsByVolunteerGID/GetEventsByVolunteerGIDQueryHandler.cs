...
{
    public class GetEventsByVolunteerGIDQueryHandler : IRequestHandler<GetEventsByVolunteerGIDQuery, IEnumerable<VolunteersEventsDTO>>
    {
        ...
        public GetEventsByVolunteerGIDQueryHandler(IRepository<VolunteersEvents> volunteerEventRepository, ICacheService<VolunteersEvents> cacheService, IMapper mapper)
        {
        ...
        public async Task<IEnumerable<VolunteersEventsDTO>> Handle(GetEventsByVolunteerGIDQuery request, CancellationToken cancellationToken)
        {
            string cacheKey = $"{nameof(GetEventsByVolunteerGIDQuery)}:{request.VolunteerGID}";
